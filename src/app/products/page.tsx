...
const ProductsPage: React.FC = () => {
  const smartSwitchProducts: Product[] = [
    // Coved Switch - Black Series
    {
      ...
      image: '/images/PRODUCT DRIVE/SMART SWITCH/COVED SWITCH - BLACK/4M 2 TOUCH + 1 CURTAIN + SOCKET.png',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Explore our comprehensive range of smart home automation products 
              designed to transform your living experience.
            </p>
          </motion.div>
