            ...
            return (
              ...
              >
                <Link href={`/products/${product.category}`}>
                  <Card className="overflow-hidden group cursor-pointer hover:shadow-2xl transition-all duration-300 bg-[#0A0A0A] border border-white/10 hover:border-blue-500/50">
